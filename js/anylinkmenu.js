...
showmenu:function(menuid){
	...
	var posx=menu.anchorobj._offsets.left + (menu.orientation=="lr"? this.dimensions.anchorw : 0) - 100 //base x pos
	...
	menu.dropmenu.setcss({left:820+'px', top:225+'px', visibility:'visible'})
