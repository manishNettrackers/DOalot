...
$.fn.editInPlace.defaults = {
	...
	save_button:		'<input type="image" src="images/okBtn.gif" style="text-decoration:none!important" class="inplace_save" />', // string: image button tag to use as “Save” button
	cancel_button:		'<img src="images/closeBtn.gif" width="10" height="10" class="inplace_cancel" />', // string: image button tag to use as 
